...
public final class TeamApplicationModuleBuilder {
    ...
    public func build() -> UIViewController {
        ...
        let storyboard = UIStoryboard(name: "TeamApplication", bundle: nil)
        let viewController = storyboard.instantiateViewController(withIdentifier: "TeamApplicationViewController") as! TeamApplicationViewController
